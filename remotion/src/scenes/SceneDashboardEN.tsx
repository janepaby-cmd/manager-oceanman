  ...
  return (
    <AbsoluteFill style={{ padding: 80, fontFamily, justifyContent: "center" }}>
      ...
      <div style={{ display: "flex", gap: 24, marginBottom: 50 }}>
        <StatCard label="Projects" value="12" color="#0078FF" delay={15} />
        <StatCard label="Active phases" value="34" color="#00C9A7" delay={25} />
        <StatCard label="Items completed" value="89%" color="#60A5FA" delay={35} />
        <StatCard label="Messages" value="7" color="#F59E0B" delay={45} />
      </div>
      <div style={{
        background: "rgba(255,255,255,0.04)", borderRadius: 16, padding: 32,
        border: "1px solid rgba(255,255,255,0.06)",
      }}>
        <ProgressBar label="OceanMan Peru 2026" pct={75} delay={50} />
        <ProgressBar label="OceanMan Italy 2026" pct={45} delay={60} />
