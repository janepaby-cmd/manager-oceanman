...
export const SceneFeatures = () => {
  ...
  const features = [
    { icon: "💬", title: "Comentarios", desc: "Hilos en cada ítem con menciones @usuario y respuestas", col: "#6366F1" },
    { icon: "📧", title: "Emails automáticos", desc: "Notificaciones al completar ítems con archivos adjuntos", col: "#0078FF" },
    { icon: "💰", title: "Gastos", desc: "Control de gastos por proyecto con OCR inteligente de tickets", col: "#F59E0B" },
    { icon: "📨", title: "Mensajería", desc: "Comunicación interna con prioridad y confirmación de lectura", col: "#10B981" },
  ];
  ...
  return (
    <AbsoluteFill style={{ fontFamily, padding: 80, justifyContent: "center" }}>
      ...
      <div style={{ display: "flex", gap: 40, marginTop: 40, justifyContent: "center" }}>
        {["🔐 Permisos RBAC", "🌐 Multiidioma", "✍️ Firma digital", "📋 Plantillas"].map((label, i) => {
